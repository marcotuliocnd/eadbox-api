/**
 * @name: Eadbox-api
 * @brief: Uma biblioteca que comunica com a api do eadbox
 *
 * Feita para ajudar empresas e empreendedores a manipular
 * os parâmetros da API da plataforma de ead Eadbox
 *
 * @author: Marco Túlio Candeo
 * @bugs: none
**/
